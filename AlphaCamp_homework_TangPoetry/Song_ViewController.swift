...
let song_url = NSURL(string: "https://kahopoon.net/poetry.php?show=poet&category=S")

class Song_ViewController: UITableViewController {
    
    let data = NSData(contentsOfURL: song_url!)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("Song_Cell", forIndexPath: indexPath)

        // Configure the cell...
        let cellData : Song_Cell = cell as! Song_Cell
        let currentData : Dictionary = self.rawData[indexPath.row]
